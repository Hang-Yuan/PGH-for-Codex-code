...
- **来源指针**：`episodic_inbox.md §J...` / `_progress/...` / `00 专注区/_本周.md`
```
...
> 由 close-node / daily-review / weekly-review 聚合 episodic_inbox 升格写入。初始为空。
...
- **行动模式**：[模型应执行的动作]
- **预期**：[未来应如何被预测验证]
- **来源指针**：`episodic_inbox.md §JYYYYMMDD-NNN`
